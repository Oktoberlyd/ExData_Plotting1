...
#Graph one
plot(household_two_dates$date_time,
      household_two_dates$Global_active_power,
      type = "l",
      xlab = "",
...
#Graph three
{
  plot(household_two_dates$Sub_metering_1 ~ household_two_dates$date_time, type="l",
       ylab="Energy sub metering", xlab="")
  lines(household_two_dates$Sub_metering_2 ~ household_two_dates$date_time,col='Red')
  lines(household_two_dates$Sub_metering_3 ~ household_two_dates$date_time,col='Blue')
...
## Graph four
     plot(household_two_dates$date_time,
          household_two_dates$Global_reactive_power,
          type = "l",
          xlab = "datetime",
